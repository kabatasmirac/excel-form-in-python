...
def __init__(self):
    ...
    self.controls = ttk.Frame(root1,width=700, height = 700+300+10)
    ...
    self.attr1=ttk.Label(self.controls,text="Meslek")
    self.attr2=ttk.Label(self.controls,text="Ad Soyad")
    self.attr3=ttk.Label(self.controls,text="Çalışma Durumu")
    self.attr4=ttk.Label(self.controls,text="Medeni Hali")
    self.attr5=ttk.Label(self.controls,text="Çocuk Sayısı")
    self.attr6=ttk.Label(self.controls,text="Ehliyet")
    self.attr7=ttk.Label(self.controls,text="Kariyer Hedefi")
    ...
    option1 = ttk.OptionMenu(self.controls, self.ent_attr1,optionslist1[0] ,*optionslist1)#optionslist1[0] ,*optionslist1 yazılmazsa optionlist1[0] elemanını yutuyor
    option1.grid(row=0,column=1, padx=5, pady=5)
    
    
    #/************************************************************************  
    self.ent_attr2=ttk.Entry(self.controls)#(Textbox)
   ...
   #/*radiobutton
    ...
    R1 = ttk.Radiobutton(self.controls, text = "Çalışıyor", 
                     variable = self.ent_attr3, value = 1)
    R2 = ttk.Radiobutton(self.controls, text = "Çalışmıyor", 
    ...
    R3 = ttk.Radiobutton(self.controls, text = "Evli", 
                     variable = self.ent_attr4, value = 1)
    R4 = ttk.Radiobutton(self.controls, text = "Bekar", 
    ...
    R5 = ttk.Radiobutton(self.controls, text = "0", 
                     variable = self.ent_attr5, value = 1)
    R6 = ttk.Radiobutton(self.controls, text = "0+", 
